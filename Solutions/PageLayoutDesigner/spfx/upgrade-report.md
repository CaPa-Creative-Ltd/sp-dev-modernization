# Upgrade project C:\Git\contrib\sp-dev-modernization\Solutions\PageLayoutDesigner\spfx to v1.10.0
...
In file [src\webparts\pageDesigner\PageDesignerWebPart.ts](src\webparts\pageDesigner\PageDesignerWebPart.ts) update the code as follows:
...
File: [src\webparts\pageDesigner\PageDesignerWebPart.ts:4:1](src\webparts\pageDesigner\PageDesignerWebPart.ts)
...
```sh
npm i -SE @microsoft/sp-core-library@1.10.0 @microsoft/sp-lodash-subset@1.10.0 @microsoft/sp-office-ui-fabric-core@1.10.0 @microsoft/sp-webpart-base@1.10.0 @microsoft/sp-dialog@1.10.0 @microsoft/decorators@1.10.0 @microsoft/sp-listview-extensibility@1.10.0 @microsoft/sp-property-pane@1.10.0
...
#### [src\webparts\pageDesigner\PageDesignerWebPart.ts](src\webparts\pageDesigner\PageDesignerWebPart.ts)
